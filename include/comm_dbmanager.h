...
#define EXE_QUERIER(queryid,paramsmap,o)\	
	CDBManager::GetInstance().ExeQuerier(queryid,paramsmap,o)
...
class CDBManager
{
	public:
		...
		static bool ExeQuerier(int inQueryId, map<string,string>& inParams,DataResult& outResult);
